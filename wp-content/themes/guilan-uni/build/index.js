...
//     document.addEventListener('keyup', this.openWithKey.bind(this));
...
// }
// openOverlay(){
//         this.searchBox.classList.add("search-overlay--active");
//         this.isOverlayOpen=true;
//     }

// closeOverlay(){
//         this.searchBox.classList.remove('search-overlay--active');
//         this.isOverlayOpen=false;
//     }
// }
// var ahad=new Search();
...
(window.webpackJsonp_fictional_university_theme = window.webpackJsonp_fictional_university_theme || []).push([
  [1],
  [function (t, e, n) { }]
]),
  function (t) {
    function e(e) {
      for (var i, s, u = e[0], a = e[1], c = e[2], f = 0, d = []; f < u.length; f++) s = u[f], Object.prototype.hasOwnProperty.call(r, s) && r[s] && d.push(r[s][0]), r[s] = 0;
    ...
    var u = window.webpackJsonp_fictional_university_theme = window.webpackJsonp_fictional_university_theme || [],
      a = u.push.bind(u);
    u.push = e, u = u.slice();
    ...
    function g(t, e, n) {
      var i = {};
      for (var o in e) p(e[o]) ? i[o] = e[o](t, i, n) : r("Extension must be a function");
      for (var s in i) p(i[s].mount) && i[s].mount();
      return i
    }
    ...
    var w = function () {
      ...
      _ = function () {
        function t(e) {
          ...
          s(this, t), this._c = {}, this._t = [], this._e = new w, this.disabled = !1, this.selector = e, this.settings = b(i, n), this.index = this.settings.startAt
        }
        return u(t, [{
          key: "mount",
          value: function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return this._e.emit("mount.before"), h(t) ? this._c = g(this, t, this._e) : r("You need to provide a object on `mount()`"), this._e.emit("mount.after"), this
          }
        }, {
          key: "mutate",
          value: function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
            return m(t) ? this._t = t : r("You need to provide a array on `mutate()`"), this
          }
        }, {
          key: "update",
          value: function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return this.settings = b(this.settings, t), t.hasOwnProperty("startAt") && (this.index = t.startAt), this._e.emit("update"), this
          }
        }, {
          key: "go",
          value: function (t) {
          ...
          set: function (t) {
            h(t) ? this._o = t : r("Options must be an `object` instance.")
          }
        }, {
          key: "index",
          get: function () {
    ...
    function S(t, e, n) {
      ...
      n || (n = {});
      var a = function () {
        u = !1 === n.leading ? 0 : k(), i = null, s = t.apply(r, o), i || (r = o = null)
      },
        c = function () {
          var c = k();
          u || !1 !== n.leading || (u = c);
    ...
    function N(t) {
      return h(t) ? (e = t, Object.keys(e).sort().reduce((function (t, n) {
    ...
    var I = {
      Html: function (t, e) {
        ...
        return y(n, "root", {
          ...
          set: function (t) {
            d(t) && (t = document.querySelector(t)), x(t) ? n._r = t : r("Root element must be a existing Html node")
          }
        }), y(n, "track", {
          get: function () {
            return n._t
          ...
          set: function (t) {
            x(t) ? n._t = t : r('Could not find track element. Please use [data-glide-el="track"] attribute.')
          }
        }), y(n, "wrapper", {
          get: function () {
        ...
        var i = {
          set: function (n) {
            var i = function (t, e, n) {
              var i = [P, L, C, z].concat(t._t, [j]);
              return {
                mutate: function (n) {
                  for (var o = 0; o < i.length; o++) {
                    var s = i[o];
                    p(s) && p(s().modify) ? n = s(t, e, void 0).modify(n) : r("Transformer should be a function that returns an object with `modify()` method")
                  }
                  return n
                }
              }
      ...
      Direction: function (t, e, n) {
        ...
        return y(i, "value", {
          ...
          set: function (t) {
            A.indexOf(t) > -1 ? i._v = t : r("Direction value must be `ltr` or `rtl`")
          }
      ...
      Peek: function (t, e, n) {
        ...
        return y(i, "value", {
          ...
          set: function (t) {
            h(t) ? (t.before = f(t.before), t.after = f(t.after)) : t = f(t), i._v = t
          }
        }), y(i, "reductor", {
          get: function () {
            var e = i.value,
        ...
        var i = {
          apply: function (t) {
            for (var n = 0, i = t.length; n < i; n++) {
              var r = t[n].style,
                o = e.Direction.value;
              r[H[o][0]] = 0 !== n ? this.value / 2 + "px" : "", n !== t.length - 1 ? r[H[o][1]] = this.value / 2 + "px" : r[H[o][1]] = ""
            }
          },
          remove: function (t) {
      ...
      Build: function (t, e, n) {
        var i = {
          ...
          activeClass: function () {
            ...
            i && (i.classList.add(n.activeSlide), T(i).forEach((function (t) {
      ...
      Run: function (t, e, n) {
        var i = {
          ...
          calculate: function () {
            var e = this.move,
              ...
              i = e.steps,
              o = e.direction,
              s = "number" == typeof f(i) && 0 !== f(i);
            switch (o) {
              case ">":
                ">" === i ? t.index = n : this.isEnd() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = 0) : s ? t.index += Math.min(n - t.index, -f(i)) : t.index++;
                break;
              case "<":
                "<" === i ? t.index = 0 : this.isStart() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = n) : s ? t.index -= Math.min(t.index, f(i)) : t.index--;
                break;
              case "=":
                t.index = i;
                break;
        ...
        return y(i, "move", {
          ...
          get: function () {
            ...
            return t.isType("slider") && "center" !== n.focusAt && n.bound ? i - 1 - (f(n.perView) - 1) + f(n.focusAt) : i - 1
          }
        }), y(i, "offset", {
          get: function () {
            return this._o
          ...
          c = {
            ...
            start: function (e) {
              if (!u && !t.disabled) {
                ...
                r = null, o = f(i.pageX), s = f(i.pageY), this.bindSwipeMove(), this.bindSwipeEnd(), n.emit("swipe.start")
              }
            },
            move: function (i) {
              if (!t.disabled) {
              ...
              if (!t.disabled) {
                ...
                this.enable(), c > a && l < s.touchAngle ? (s.perTouch && (d = Math.min(d, f(s.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve("<" + d))) : c < -a && l < s.touchAngle ? (s.perTouch && (d = Math.max(d, -f(s.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve(">" + d))) : e.Move.make(), e.Html.root.classList.remove(s.classes.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), n.emit("swipe.end")
              }
            },
            bindSwipeStart: function () {
              var n = this,
                r = t.settings;
              r.swipeThreshold && i.on(q[0], e.Html.wrapper, (function (t) {
                n.start(t)
              }), a), r.dragThreshold && i.on(q[1], e.Html.wrapper, (function (t) {
                n.start(t)
              }), a)
            },
            unbindSwipeStart: function () {
              i.off(q[0], e.Html.wrapper, a), i.off(q[1], e.Html.wrapper, a)
            },
            bindSwipeMove: function () {
              var n = this;
              i.on(B, e.Html.wrapper, S((function (t) {
                n.move(t)
        ...
        var i = new O,
          ...
          o = {
            ...
            addClass: function (e) {
              var n = t.settings,
                i = e[t.index];
              i && (i.classList.add(n.classes.activeNav), T(i).forEach((function (t) {
      ...
      Breakpoints: function (t, e, n) {
        ...
        return a(r, u.match(o)), i.on("resize", window, S((function () {
          t.settings = b(r, u.match(o))
      ...
      V = function (t) {
        ...
        return function (t, e) {
          ...
          value: function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, a({}, I, t))
          }
        }]), e
      }(_);
    new class {
      constructor() {
        this.menu = document.querySelector(".site-header__menu"), this.openButton = document.querySelector(".site-header__menu-trigger"), this.events()
      }
      events() {
        this.openButton.addEventListener("click", () => this.openMenu())
      }
      openMenu() {
        this.openButton.classList.toggle("fa-bars"), this.openButton.classList.toggle("fa-window-close"), this.menu.classList.toggle("site-header__menu--active")
      }
    }, new class {
      constructor() {
        if (document.querySelector(".hero-slider")) {
          const t = document.querySelectorAll(".hero-slider__slide").length;
          let e = "";
          for (let n = 0; n < t; n++) e += `<button class="slider__bullet glide__bullet" data-glide-dir="=${n}"></button>`;
          document.querySelector(".glide__bullets").insertAdjacentHTML("beforeend", e), new V(".hero-slider", {
            type: "carousel",
            perView: 1,
            autoplay: 3e3
          }).mount()
...
//     this.closeBtn = document.querySelector('.search-overlay__close');
//     this.searchBox = document.querySelector('.search-overlay');
//     this.searchFeild = document.querySelector('#search-term');
//     this.isOverlayOpen = false;
...
//     this.closeBtn.addEventListener('click', this.closeOverlay.bind(this));
//     document.addEventListener('keyup', this.openWithKey.bind(this));
//     this.searchFeild.addEventListener('keyup', this.sendReq.bind(this));
...
//       if (this.feildVal != this.searchFeild.value) {
//         clearTimeout(this.reqTimmer);
//         if (!this.isSpinnerOn) {
//           this.showResult.innerHTML = '<div class="spinner-loader"</div>';
//           this.isSpinnerOn = true;
//         }
//         this.reqTimmer = setTimeout(this.result.bind(this), 2000);
//       }
//     } else {
...
//     this.feildVal = this.searchFeild.value;
//   }

//   result() {
//      xhr=new XMLHttpRequest();
//     xhr.open('GET','http://localhost/wordpress/wp-json/wp/v2/posts');
//     xhr.addEventListener('readystatechange',function(){
//       if(xhr.readystatechange==4){
//         this.showResult.innerHTML=xhr.responseText;
//       }
//     }.bind(this));
...
//   }
//   openWithKey(e) {
//     if (e.keyCode == 219 || e.keyCode == 175 && !this.isOverlayOpen) {
//       this.openOverlay();
//     }
...
const searchBtn = document.querySelectorAll('.js-search-trigger');
const closeBtn = document.querySelector('.search-overlay__close');
const searchBox = document.querySelector('.search-overlay');
const searchFeild = document.querySelector('#search-term');
let isOverlayOpen = false;
let isSpinnerOn = false;
let feildVal;
let reqTimmer;

openOverlay = function () {
  searchBox.classList.add("search-overlay--active");
  searchFeild.value = '';
...
closeOverlay = function () {
  searchBox.classList.remove('search-overlay--active');
  document.body.classList.remove('fix-page');
  isOverlayOpen = false;
}
openWithKey = function (e) {
  if (e.keyCode == 219 || e.keyCode == 175 && !isOverlayOpen) {
    openOverlay();
  }
...
sendReq = function () {
  if (searchFeild.value) {
    if (feildVal != searchFeild.value) {
      clearTimeout(reqTimmer);
      if (!isSpinnerOn) {
        showResult.innerHTML = '<div class="spinner-loader"</div>';
        isSpinnerOn = true;
      }
      reqTimmer = setTimeout(result, 800);
    }
  } else {
    showResult.innerHTML = '';
    isSpinnerOn = false;
  ...
  feildVal = searchFeild.value;
}
result = function () {
  //  const xhr1 = new XMLHttpRequest();
  //  xhr1.open('GET',uniData.siteUrl +'/wp-json/wp/v2/posts?search='+searchFeild.value);
  //  xhr1.addEventListener('readystatechange',function(){
  //    if(xhr1.readyState==4){
  //      let posts=JSON.parse(xhr1.responseText);
  //      console.log(posts);
  //      showResult.innerHTML=`
  //      <h2 class='search-overlay__section-title'>مطالب یافت شده</h2>

  //      ${posts.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
  ...
  fetch(uniData.siteUrl + '/wp-json/university/v1/info?search=' + searchFeild.value)
    .then((Response) => {
      ...
      <div class='row'>
      <div class='one-third'>
      <h2 class='search-overlay__section-title'>پست ها و صفحات</h2>
      ${text.general.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
      ${text.general.map(post => `<li><a href='${post.link}'>${post.title}</a></li>`).join('')}
      ${text.general.length ? '</ul>' : ''}
      </div>
      <div class='one-third'>
      <h2 class='search-overlay__section-title'>اساتید</h2>
      ${text.profesor.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
      ${text.profesor.map(post => `<li><a href='${post.link}'>${post.title}</a></li>`).join('')}
      ${text.profesor.length ? '</ul>' : ''}
      <h2 class='search-overlay__section-title'>رشته ها</h2>
      ${text.program.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
      ${text.program.map(post => `<li><a href='${post.link}'>${post.title}</a></li>`).join('')}
      ${text.program.length ? '</ul>' : ''}
      </div>
      <div class='one-third'>
      <h2 class='search-overlay__section-title'>رویداد ها</h2>
      ${text.event.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
      ${text.event.map(post => `<li><a href='${post.link}'>${post.title}</a></li>`).join('')}
      ${text.event.length ? '</ul>' : ''}
      </div>
  ...
  //delete me later bro
  // const urls = [
  //   uniData.siteUrl +'/wp-json/wp/v2/posts?search='+searchFeild.value,
  //   uniData.siteUrl +'/wp-json/wp/v2/pages?search='+searchFeild.value
  // ];
  ...
  //     })
  // )).then(data => {
  //   let amir= data[0].concat(data[1]);
  //   console.log(data);
  //   showResult.innerHTML=`
  //      <h2 class='search-overlay__section-title'>مطالب یافت شده</h2>

  //      ${amir.length ? "<ul class='link-list min-list'>" : '<p>نتیجه ای یافت نشد</p>'}
  //      ${amir.map(post=>`<li><a href='${post.link}'>${post.title.rendered}</a></li>`).join('')}
  //      ${amir.length ? '</ul>' : ''}
  ...
  // fetch(uniData.siteUrl +'/wp-json/wp/v2/posts?search='+searchFeild.value)
  // .then((Response)=>{
  //   return Response.text();
  // }).then((text1)=>{
  //   const ahad=text1;
  // });
  // fetch(uniData.siteUrl +'/wp-json/wp/v2/pages?search='+searchFeild.value)
  // .then((Response)=>{
  //   return Response.text();
  // }).then((text2)=>{
  //   const ali=text2;
  ...
  // Promise.all([fetch(uniData.siteUrl +'/wp-json/wp/v2/posts?search='+searchFeild.value),fetch(uniData.siteUrl +'/wp-json/wp/v2/pages?search='+searchFeild.value)])
  // .then((Response)=>{
  //   Response.forEach((ahad)=>{
  //     console.log(ahad);
  //   }).then((text)=>{
  //     console.log(text);
  //   })
...
searchFeild.addEventListener('keyup', sendReq);

//my-notes-page-codes

const deleteBtn = document.querySelectorAll('.delete-note');
const editBtn = document.querySelectorAll('.edit-note');
const ahadm = document.querySelector('#my-notes');
if (ahadm) {
  ahadm.addEventListener('click', function (e) {
    let element1 = e.target;
    if (element1.tagName == 'I' && element1.classList.contains("delete-note")) {
      let list = e.target.parentElement;
      fetch(uniData.siteUrl + '/wp-json/wp/v2/note/' + list.dataset.id, {
        method: 'DELETE',
        headers: {
      ...
      }).then((text) => console.log(text)).catch((error) => console.log(error));
    }
  ...
  ahadm.addEventListener('click', function (e) {
    let element1 = e.target;
    if (element1.tagName == 'I' && element1.classList.contains("edit-note")) {
      let list = e.target.parentElement;
      let textPlace = list.querySelectorAll('.text-place');
      let updatebtn = list.querySelector('.update-note');

      if (list.dataset.state == 'readonly') {
        makeediteable();
      } else {
        makereadonly();
      }
      function makeediteable() {
        list.querySelector('.edit-note').classList.replace('fa-pencil', 'fa-times');
        updatebtn.classList.add('update-note--visible');
        textPlace.forEach(item => {
          item.removeAttribute('readonly');
          item.classList.add('note-active-field');
        });
        list.dataset.state = 'edittime'
      }
      function makereadonly() {
        list.querySelector('.edit-note').classList.replace('fa-times', 'fa-pencil');
        updatebtn.classList.remove('update-note--visible');
        textPlace.forEach(item => {
          item.setAttribute('readonly', '');
          item.classList.remove('note-active-field');
        });
        list.dataset.state = 'readonly'

      }
    }

  });
  let updatebtn = document.querySelectorAll('.update-note');


  ahadm.addEventListener('click', function (e) {
    let element1 = e.target;
    if (element1.tagName == 'I' && element1.classList.contains("update-note")) {
      let list = e.target.parentElement;
      let data = {
        'title': document.querySelector('.note-title-field').value,
        'content': document.querySelector('.note-body-field').value
      }
      fetch(uniData.siteUrl + '/wp-json/wp/v2/note/' + list.dataset.id, {
        method: 'POST',
        headers: {
        ...
        if (Response.ok) {
          list.querySelector('.edit-note').classList.replace('fa-times', 'fa-pencil');
          e.target.classList.remove('update-note--visible');
          let textPlace = list.querySelectorAll('.text-place');
          textPlace.forEach(item => {
            item.setAttribute('readonly', '');
            item.classList.remove('note-active-field');
  ...
  // create note functions are here ---------------------->>>>>>>>>>
  let createBtn = document.querySelector('.submit-note');
  ...
  createBtn.addEventListener('click', function (e) {
    ...
    fetch(uniData.siteUrl + '/wp-json/wp/v2/note/', {
      method: 'POST',
      headers: {
        'X-WP-Nonce': uniData.nonce,
        "Content-type": "application/json; charset=UTF-8"
      ...
      liTemplate.setAttribute('data-state', 'readonly');
      liTemplate.setAttribute('data-id', `${text.id}`);
      liTemplate.innerHTML = `
      <input readonly class="text-place note-title-field" value="${text.title.raw}">
     <i class='fa fa-pencil edit-note' aria-hidden="true">ویرایش</i>
     <i class='fa fa-trash delete-note' aria-hidden="true">حذف</i>
      <textarea readonly class="text-place note-body-field">${text.content.raw}</textarea>
      <i class='update-note btn btn--blue btn--small fa fa-arrow-left' aria-hidden="true">ذخیره</i>
      `
      document.querySelector('#my-notes').prepend(liTemplate);
    })
      .catch(error => console.log(error));
  });
}
const removeLike = function (item) {
  let data1 = { 'like': item.dataset.likeid }
  fetch(uniData.siteUrl + '/wp-json/likeApi/v1/info/', {
    method: 'DELETE',
    headers: {
      'X-WP-Nonce': uniData.nonce,
      "Content-type": "application/json; charset=UTF-8"
    ...
    item.dataset.exists = 'no';
    let likeCount = item.querySelector('.like-count').textContent;
    likeCount--;
    item.querySelector('.like-count').textContent = likeCount;
    item.dataset.likeid = '';
  })
}

const addLike = function (profesor, item) {
  let data = {
    'ID': profesor
  }
  fetch(uniData.siteUrl + '/wp-json/likeApi/v1/info/', {
    ...
    item.dataset.exists = 'yes';
    let likeCount = item.querySelector('.like-count').textContent;
    likeCount++;
    item.querySelector('.like-count').textContent = likeCount;
    item.setAttribute('data-likeid',text) ;
  });
}
...
//create a likes featur for this amazing site--------------->>>>>>>>>>>>>>>>>>>>>
const likeBtn = document.querySelectorAll('.like-box');
likeBtn.forEach((item) => {
  if(item.dataset.islogin =='yes'){
    let professor = item.dataset.professorid;
    item.addEventListener('click', function (e) {
      if (item.dataset.exists == 'yes') {
        removeLike(item);
      } else {
        addLike(professor, item);
      }
    })
  }else{
